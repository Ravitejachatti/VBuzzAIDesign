// in college dashaboard, we will have notices(get all notices(notices of job, and other the api will give), (create, update, delete) notices will be done by api , get all students of that college with filters(api), placement reports of student of that college with filters(api), can see the departments and programs under those departmetns in that college(api calls), setting of their dashboard, create faculty(add faculty, edit and delete faculty) )
