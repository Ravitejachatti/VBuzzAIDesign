...
const UpdateParentDetails = ({ goToNext }) => {
  ...
  useEffect(() => {
    const fetchParentDetails = async () => {
      try {
        ...
        setParentDetails({
          name: studentData.parentDetails?.name || "",
          contactNumber: studentData.parentDetails?.contactNumber || "",
          occupation: studentData.parentDetails?.occupation || "",
          address: studentData.parentDetails?.address || "",
        });

        setLoading(false);
      } catch (error) {
        console.error("Failed to fetch parent details:", error);
        setMessage({ text: "Failed to fetch parent details.", type: "error" });
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage({ 
        text: "Failed to update parent details.", 
        type: "error" 
      });
    }
  };
