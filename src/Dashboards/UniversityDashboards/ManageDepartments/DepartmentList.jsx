...
const DepartmentList = ({colleges, programs}) => {
  ...
  const BASE_URL = import.meta.env.VITE_API_BASE_URL; // Base URL from environment variables
  ...
  console.log("Colleges in DepartmentList:", colleges);
  console.log("Programs in DepartmentList:", programs);
