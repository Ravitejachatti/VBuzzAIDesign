...
const JobManager = ({ colleges, departments, programs }) => {
  ...
  const fetchjobs = async () => {
   ...
   if(result.meta.requestStatus === "fulfilled"){setFilteredJobs(jobs)}
   
  };
  console.log("Jobs in job manager:", jobs);
  console.log("Filtered Jobs in job manager:", filteredJobs);
  console.log("Departments in job manager:", departments);
  console.log("colleges in job manager:", colleges);
  console.log("departments in job manager:", departments);
  console.log("programs in job manager:", programs);
              ...
              {jobs.length > 0 ? (
                jobs.map((job, index) => (
                  <tr key={job._id} className="border-b">
                    ...
                    <td className="border px-2 py-1 text-xs">{job.programs?.map(getProgramNameById).join(", ")}</td>
                    ...
                    <td className="border px-2 py-1 text-xs">{new Date(job?.closingDate).toLocaleString()}</td>
                    ...
                    <td className="border px-2 py-1 text-xs">
                      ...
                      <button
                        ...
                        className="bg-red-500 text-white px-1 py-1 text-xs rounded mt-1"
                      >
                        Delete
                      </button>
                    </td>
