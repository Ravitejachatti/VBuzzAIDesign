...
const ManageNotice = ({colleges, departments, programs, students}) => {
  ...
  console.log("studnets in manage notice:", students)
  ...
  const fetchNotices = async () => {
    try {
      ...
      console.log("Manage Notice:",sortedNotices)
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`${BASE_URL}/notice/${deleteNoticeId}`, {
        headers: { Authorization: `Bearer ${token}` },
        params: { universityName },
      });
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`${BASE_URL}/notice/${editNotice._id}`, editNotice, {
        headers: { Authorization: `Bearer ${token}` },
        params: { universityName },
      });
      setEditNotice(null);
